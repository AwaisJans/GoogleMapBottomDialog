package com.jexample.sample.picture.firstnametest.dialog
...
import com.jexample.sample.picture.firstnametest.R
import com.jexample.sample.picture.firstnametest.adapters.ImagesAdapter
import com.jexample.sample.picture.firstnametest.databinding.BottomSheetBehaviorBinding
...
import com.jexample.sample.picture.firstnametest.model.urlDetailsMarker.SingleApiService
...
//            textView.setCompoundDrawablesWithIntrinsicBounds(null, drawable, null, null)
    ...
    private fun setupKategories(kategoriesList:List<Kategorie>){
        ...
        for (item in kategoriesList) {
            ...
            textView.setBackgroundResource(com.jexample.sample.picture.firstnametest.R.drawable.bg_kategory)
